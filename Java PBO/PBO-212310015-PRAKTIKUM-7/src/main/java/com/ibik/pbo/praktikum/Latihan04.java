...
public class Latihan04 extends JFrame implements ActionListener {
    ...
    private void GenerateForm(Latihan04 frameForm) {
        ...
        title_form.setFont(new Font("Times New Roman", Font.BOLD, 20));
        ...
        nilai_a = new JRadioButton("A"); 
        nilai_b = new JRadioButton("B");
        nilai_c = new JRadioButton("C");
        nilai_d = new JRadioButton("D");
        nilai_e = new JRadioButton("E"); 
        nilai_f = new JRadioButton("F");
        
        nilai_a.setBounds(40, 260, 35, 20); 
        nilai_b.setBounds(80, 260, 35, 20);
        nilai_c.setBounds(120, 260, 35, 20); 
        nilai_d.setBounds(160, 260, 35, 20);
        nilai_e.setBounds(200, 260, 35, 20); 
        nilai_f.setBounds(240, 260, 35, 20);

        group_nilai.add(nilai_a); 
        group_nilai.add(nilai_b);
        group_nilai.add(nilai_c); 
        group_nilai.add(nilai_d);
        group_nilai.add(nilai_e); 
        group_nilai.add(nilai_f);

        formPanel.add(nilai_a); 
        formPanel.add(nilai_b);
        formPanel.add(nilai_c); 
        formPanel.add(nilai_d);
        formPanel.add(nilai_e); 
        formPanel.add(nilai_f);

        btn_save = new JButton("Save");
        btn_delete = new JButton("Delete");
        btn_clear = new JButton("Clear");

        btn_save.setBounds(40, 300, 75, 35);
        btn_delete.setBounds(130, 300, 75, 35);
        btn_clear.setBounds(220, 300, 75, 35);
        ...
        String data[][]={ {"212310015","Dyas Tri Apriliansyah","A"}, 
        		 ...
        		 frameForm.add(jt, BorderLayout.EAST);
    }
